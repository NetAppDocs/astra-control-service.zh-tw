...
* https://["檢視Cloud Volumes Service 報價詳細資料以供參考"^]。
+
請注意、Astra Control Service支援所有服務類型和服務層級。您使用的服務類型取決於 https://["Google Cloud區域"^]。

* https://["檢視Google Cloud儲存桶的定價詳細資料"^]。
...
* https://["檢視Azure NetApp Files 報價詳細資料以供參考"^]。
* https://["檢視Microsoft Azure Blob儲存設備的定價詳細資料"^]。
...
* https://["檢視Amazon Web Services的價格詳細資料"^]。
...
NOTE: 若要觀看Azure Marketplace訂閱程序的逐步解說影片、請造訪 https://["NetApp TV"^]。

.步驟
. 前往 https://["Azure Marketplace"^]。
. 選擇*立即取得*。
. 請依照指示訂閱計畫。
