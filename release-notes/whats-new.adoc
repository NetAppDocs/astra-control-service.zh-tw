...
* 支援NetApp Cloud Volumes ONTAP 作為儲存後端（正式支援Microsoft Azure和Google Cloud平台）
+
link:../learn/architecture.html#astra-control-components["架構與元件"]
...
* 支援將自我管理的Kubernetes叢集新增至Astra Control Service
+
link:../get-started/add-first-cluster.html["從Astra Control Service開始管理Kubernetes叢集"]
